...
trainlabel = read_data('../ML_data/train_label_2.csv')
trainphase = read_data('../ML_data/train_phase_2.csv')
trainrssi = read_data('../ML_data/train_rssi_2.csv')
testlabel = read_data('../ML_data/test_label_2.csv')
testphase = read_data('../ML_data/test_phase_2.csv')
testrssi = read_data('../ML_data/test_rssi_2.csv')
